  ...
  <form class="" action="/forms/projects/" method="post">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <input type="text" class="form-control" id="sandbox_url" sandbox_url="sandbox_url" value="{if $p}{$p->data('sandbox_url')}{else}{$form->getPost('sandbox_url')}{/if}">
      </div>
    </div>
    <br>
    <div class="row">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <input type="text" class="form-control" id="trello_id" trello_id="trello_id" value="{if $p}{$p->data('trello_id')}{else}{$form->getPost('trello_id')}{/if}">
      </div>
    </div>
    <br>
    <div class="row">
      <div class="col-md-12">
        ...
        <input type="text" class="form-control" id="slack_id" slack_id="slack_id" value="{if $p}{$p->data('slack_id')}{else}{$form->getPost('slack_id')}{/if}">
      </div>
    </div>
